function QQQ = tjqC25(Qua_mat, t_step, total_seg_num, beta_array)
    % 检查输入的尺寸和一致性
    ...
    % 定义 B_matrix 和 M 矩阵
    B_matrix = arrayfun(@(i) B(i, 5), 0:5);
    syms beta_i beta_ip1 real;  % 定义符号变量
    M = [0, 1, 0, 0;
        -beta_i/5, 1, beta_i/5, 0;
        -(7/20)*beta_i , 1-beta_i/10 , (9/20)*beta_i , 0;
        0 , (9/20)*beta_ip1 , 1-beta_ip1/10 , -(7/20)*beta_ip1;
        0 , beta_ip1/5 , 1 , -beta_ip1/5;
        0 , 0 , 1 , 0];
